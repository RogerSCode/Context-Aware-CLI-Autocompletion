...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Geben Sie Ihren Namen hier an: Roger Sellin

\newcommand{\bearbeiter}{Roger Sellin}

% Geben Sie hier den Titel Ihrer Arbeit an:
\newcommand{\titel}{Context-Aware CLI autocompletion }

% Geben Sie das Datum des Beginns und Ende der Bachelorarbeit ein:
\newcommand{\beginndatum}{7. june 2023}
\newcommand{\abgabedatum}{7.~September~2023}

% Geben Sie die Namen des Erst- und Zweitgutachters an:
\newcommand{\erstgutachter}{Dr.~Konrad Völkel}
\newcommand{\zweitgutachter}{Dr. Marcus Brenneis}
